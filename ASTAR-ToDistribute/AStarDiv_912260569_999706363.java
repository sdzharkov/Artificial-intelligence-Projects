...
public class AStarDiv_912260569_999706363 implements AIModule
{
    public class Cell{
        public int x,y;
        public Point self;
    ...
    {
        double z2 = map.getTile(endPoint);
        double z1 = map.getTile(curPoint);
        double z = z2 - z1;
        ...
        if (z > 0)
        {
            ...
            // else
            //     return manhattan * Math.pow(2, (z / manhatta=n));
            if (z1 != 0)
                return manhattan / (z2 + 1);
            else
            {
                if (manhattan == 1)
                    return 0;
