...
public class stephanAI implements AIModule
{
    public class Cell{
        public int x,y;
        public Point self;
    ...
    public List<Point> createPath(final TerrainMap map)
    {
        ...
        HashMap<String, Cell> closed = new HashMap<String, Cell> (); // Try and just use boolean for opened
...
//        {
//            if (x >= y)
//                return Math.floor(y + (x - y)); // 2 doesnt work
//            else
//                return Math.floor(x + (y - x)); // 2 doesnt work
//        }
//
//        if (z < 0)
//        {
//            if (x >= y)
//                return Math.floor(y + (x - y)) /2;
//            else
//                return Math.floor(x + (y - x)) /2;
//        }
//
//        // else
//        // {
